...
var isHungry = true;
var numberOfPets = 1;
console.log(myName, isHungry, numberOfPets);

// IN WORDS:
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  /*
  I chose a string for myName, as most names are made up of letters and so a
  str variable suits that need. isHungry needs to be a boolean, because I'm either
  hungry or I'm not. Finally, numberOfPets needs to be a number, so I chose the
  number variable.
  */
